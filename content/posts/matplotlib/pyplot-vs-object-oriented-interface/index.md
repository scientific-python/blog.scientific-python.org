...
![A PyPlot figure of the speed of a free-falling object. The distance is plotted on the Y-axis and the time is on the X-axis. The values are shown by blue dots joined by a blue colour smooth curve. The values tend to increase upwards.](figure/just-distance.png)
